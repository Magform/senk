...
#define DISTANCE_BETWEEN_SET 10 //milliseconds to wait between two different dataset, time is taken at the last data of the last dataset
...
#define DATA_SAVER_STATUS 1 //1 to turn it on 0 to turn it off data saving to local storage
...
#define DATA_SENDER 1 //Read data from file and send it (Need DATA_SAVER_STATUS enable to work), it send all data only one time
